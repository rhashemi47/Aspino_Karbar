...
public class SyncInsertUserServiceHamyarStar {
	...
	public SyncInsertUserServiceHamyarStar(Activity activity,
		...
		this.karbarCode = UserServiceCode;
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
	            ...
	            {
	            	Toast.makeText(this.activity.getApplicationContext(),"امتیاز ثبت گردید",Toast.LENGTH_LONG);
	            }
        	}
        	else
        	{
	...
	public void InsertDataFromWsToDb(String AllRecord)
    {
		...
		Cursor cursor=db.rawQuery("SELECT * FROM City WHERE Name='"+"CityCodeLocation"+"'",null);//todo
		if(cursor.getCount()>0)
		{
			cursor.moveToNext();
			SyncServices syncservices=new SyncServices(this.activity,"0","0");

...
public class SyncUpdateAcceptHamyarFinalPrice {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
        	...
        	try
        	{
        		CallWsMethod("UpdateAcceptHamyarFinalPrice");
        	}
	    	catch (Exception e) {
	...
	public void CallWsMethod(String METHOD_NAME) {
	    ...
	    PropertyInfo RequestCodePI = new PropertyInfo();
	    //Set Name
		RequestCodePI.setName("RequestCode");
	    //Set Value
		RequestCodePI.setValue(RequestCode);
	    //Set dataType
		RequestCodePI.setType(String.class);
	    //Add the property to request object
	    request.addProperty(RequestCodePI);
	    //Create envelope

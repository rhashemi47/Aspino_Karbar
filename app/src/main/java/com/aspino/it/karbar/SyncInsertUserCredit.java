...
public class SyncInsertUserCredit {
	...
	//Contractor
	public SyncInsertUserCredit(Activity activity, String Price, String pkarbarCode, String Method, String DocNumber, String Description) {

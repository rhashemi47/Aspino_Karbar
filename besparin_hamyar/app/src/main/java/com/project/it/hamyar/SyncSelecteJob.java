	...
	public void InsertDataFromWsToDb()
    {
		...
		if(coursors.getCount()>0)
		{
			...
			query="INSERT INTO BsHamyarSelectServices (Code," +
					...
					",CarType" +
					",Language" +
					",InsertDate,IsDelete,Status) VALUES('"+coursors.getString(coursors.getColumnIndex("Code"))+
					...
					"','0','1')";//status 1 is select- 2 is pause - 3 is pause - 4 is cansel - 5 is visit - 6 is perfactor

...
public class SyncPauseJob {
	...
	//Contractor
	public SyncPauseJob(Activity activity, String guid, String hamyarcode, String UserServiceCode, String rowid) {
	...
	private class AsyncCallWS extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
        	if(result == null)
        	{
				...
				{
					Toast.makeText(this.activity.getApplicationContext(), "وقفه اعمال شد", Toast.LENGTH_LONG).show();

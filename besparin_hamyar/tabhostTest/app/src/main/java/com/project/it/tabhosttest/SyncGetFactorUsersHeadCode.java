...
public class SyncGetFactorUsersHeadCode {
	...
	//Contractor
	public SyncGetFactorUsersHeadCode(Activity activity, String guid, String hamyarcode, String UserServiceCode, String Year, String Month, String Day, String Description) {
